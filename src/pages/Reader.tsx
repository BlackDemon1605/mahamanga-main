...
export default function Reader() {
  ...
  return (
    <div className="fixed inset-0 bg-background z-50">
      ...
      >
        <div className="glass-strong flex items-center justify-between h-14 px-4 border-b border-border/50 safe-area-top safe-area-x">
      ...
      <div 
        className="h-full overflow-y-auto pt-safe-header pb-safe-nav safe-area-x"
        onClick={handleTap}
      >
      ...
      >
        <div className="glass-strong flex items-center justify-between h-16 px-4 border-t border-border/50 safe-area-bottom safe-area-x">
          <Button
            variant="outline"
